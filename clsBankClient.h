...
private:
    ...
    static vector <clsBankClient> _LoadClientsDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("Clients Info", ios::in);//read Mode
    ...
    static void _SaveCleintsDataToFile(vector <clsBankClient> vClients)
    {
        ...
        fstream MyFile;
        MyFile.open("Clients Info", ios::out);//overwrite
    ...
    {
        fstream MyFile;
        MyFile.open("Clients Info", ios::out | ios::app);
...
public:
    ...
    static clsBankClient Find(string AccountNumber)
    {
        ...
        fstream MyFile;
        MyFile.open("Clients Info", ios::in | ios::app);//read Mode
